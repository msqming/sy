...
def save_file(proxy_list):
    with open('/home/ypp/pycode/Amazontoys/Amazontoys/proxies.txt','w') as f:
...
def main():
    url = 'http://webapi.http.zhimacangku.com/getip?num=15&type=2&pro=&city=0&yys=0&port=11&time=1&ts=1&ys=0&cs=1&lb=1&sb=0&pb=5&mr=1&regions='
    html = get_index(url)
    if html:
