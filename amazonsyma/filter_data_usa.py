...
def conn_mysql():
    ...
    # 取数据
    cursor.execute('select * from syma where spider_time="20180608" and site="usa"')

    data1 = cursor.fetchall()

    cursor.execute('select * from syma where spider_time = "20180609" and site="usa"')
...
def save_to_file(data1,data2):
    with open('20180609_usa.txt','w',encoding='utf-8') as f:

        f.write('2018年6月9日，syma产品在亚马逊美国站的排名' + '\n')
