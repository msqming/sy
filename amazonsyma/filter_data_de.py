...
def conn_mysql():
    ...
    # 取数据
    cursor.execute('select * from syma where spider_time="20180608" and site="de"')

    data1 = cursor.fetchall()

    cursor.execute('select * from syma where spider_time = "20180609" and site="de"')
...
def save_to_file(data1,data2):
    with open('20180609_de.txt','w',encoding='utf-8') as f:

        f.write('2018年6月9日，syma产品在亚马逊德国站的排名' + '\n')
