...
def conn_mysql():
    ...
    # 取数据
    cursor.execute('select * from syma where spider_time="20180608" and site="it"')

    data1 = cursor.fetchall()

    cursor.execute('select * from syma where spider_time = "20180609" and site="it"')
...
def save_to_file(data1,data2):
    with open('20180609_it.txt','w',encoding='utf-8') as f:

        f.write('2018年6月9日，syma产品在亚马逊及意大利站的排名' + '\n')
